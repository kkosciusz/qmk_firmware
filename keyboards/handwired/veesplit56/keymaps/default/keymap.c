...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] =
  ...
  , [_NAV] = LAYOUT_split_4x6_4(
        ...
        _______,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    /**/     KC_INS,     KC_HOME,    XXXXXXX,    KC_END,     XXXXXXX,    _______,
